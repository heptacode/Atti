...
import app.atti.Activities.QNAActivity.QNA_Detail_activity;
import app.atti.Object.QNA_Post;
import app.atti.R;

public class QNA_RecyclerAdapter extends   RecyclerView.Adapter<QNA_RecyclerAdapter.ViewHolder>{
    ...
    public QNA_RecyclerAdapter(ArrayList<QNA_Post> items) {
        this.items = items;
    }

    @NonNull
    @Override
    public QNA_RecyclerAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, final int position) {
        ...
        holder.LL_intent.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                //document 이름 값
                Intent maindetail = new Intent(holder.itemView.getContext(), QNA_Detail_activity.class);
...
//                                    items.get(position).setLike(Integer.parseInt(task.getResult().get("like").toString()) + 1);
                                        ...
                                        QNA_RecyclerAdapter.this.notifyDataSetChanged();
                                        holder.likeimg.setImageResource(R.drawable.ic_liked);
