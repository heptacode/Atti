...
public class QNA_Write extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        et_content = findViewById(R.id.qna_write_content);
        et_title = findViewById(R.id.qna_write_title);
        write = findViewById(R.id.qna_write_write);
        image_add = findViewById(R.id.qna_write_btn_float);
        prev = findViewById(R.id.qna_write_previmg);
